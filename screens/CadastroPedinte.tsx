...
const CadastroPedinte = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.cadastroPedinte05}>
      <View style={styles.superior}>
        ...
        />
        <Text style={[styles.titulo, styles.tituloTypo]}>JUNTE-SE A NÓS</Text>
      ...
      <View style={styles.termoscondies}>
        <Text style={styles.ttulo}>TERMOS E CONDIÇÕES</Text>
        <Pressable
          style={[styles.seta, styles.setaPosition]}
          onPress={() => navigation.navigate("CadastroPedinte1")}
        >
          <Image
            style={styles.icon}
            contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  termosChild: {
    backgroundColor: "rgba(18, 135, 242, 0.38)",
    width: 332,
    borderRadius: Border.br_xl,
    left: 0,
    top: 0,
...
export default CadastroPedinte;
