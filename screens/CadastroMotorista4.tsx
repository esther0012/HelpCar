...
const CadastroMotorista4 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.cadastroMotorista01}>
      <View style={styles.dadosPessoais}>
        ...
        <View style={styles.titulosCaixaTexto}>
          <Text style={[styles.gnero, styles.nomeTypo]}>GÊNERO</Text>
          <Text style={[styles.celular, styles.nomeTypo]}>CELULAR</Text>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/caixas-texto1.png")}
        />
