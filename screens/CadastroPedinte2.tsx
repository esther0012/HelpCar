...
const CadastroPedinte2 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.cadastroPedinte03}>
      <View style={styles.dadosPessoais}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/caixas-texto2.png")}
        />
...
`}</Text>
      ...
      <View style={styles.superior}>
        ...
        />
        <Text style={[styles.subtitulo1, styles.titulo1Typo]}>
...
export default CadastroPedinte2;
